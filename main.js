...
const PRODUCT_LIST = [
  { name: "Mumtas Mie – Habbasauda", desc: "Kopi herbal 7 akar, praktis dan berkhasiat.", img: "https://res.cloudinary.com/doqzgozyt/image/upload/v1758607885/Gemini_Generated_Image_lacm82lacm82lacm_mc8mvs.png" },
...
const ALL_PRODUCTS = [
  { code: "NOS-003", name: "Natura Oil Squa", category: "Herbal Care", short: "Suplemen premium dengan kandungan squalene murni yang membantu tubuh tetap bertenaga dan optimal setiap hari.", img: "https://res.cloudinary.com/doqzgozyt/image/upload/v1758627658/Gemini_Generated_Image_ec93u5ec93u5ec93_xn3hvz.png", imgs: ["https://res.cloudinary.com/doqzgozyt/image/upload/v1758627658/Gemini_Generated_Image_ec93u5ec93u5ec93_xn3hvz.png"], priceAgent: 150000, priceConsumer: 175000, points: 20, longDesc: { manfaat: `<p>Konsumsi rutin membantu menjaga vitalitas, meningkatkan daya tahan tubuh, serta memperkuat sistem kekebalan secara menyeluruh.</p>`, komposisi: `<p>Tiap softgel mengandung: Squalene (dari minyak hati ikan hiu) 650mg</p>`, penyajian: `<p>Untuk konsumsi: 1-2 kali sehari 1 softgel atau sesuai dengan petunjuk dokter.</p>` } },
  { code: "GMK-013", name: "Gamin Gathuk", category: "Herbal Care", short: "Suplemen kolagen dan albumin alami untuk mempercepat pemulihan tubuh dari dalam.", img: "https://res.cloudinary.com/doqzgozyt/image/upload/v1758520869/Gamin_Gathuk_lmzvyg.png", imgs: ["https://res.cloudinary.com/doqzgozyt/image/upload/v1758520869/Gamin_Gathuk_lmzvyg.png"], priceAgent: 100000, priceConsumer: 125000, points: 25, longDesc: { manfaat: `<p>Gamin Gathuk merupakan perpaduan ekstrak ikan gabus yang kaya albumin dan ekstrak gamat yang tinggi kolagen. Kombinasi ini membantu proses regenerasi jaringan, mempercepat penyembuhan luka, serta mendukung fungsi transportasi nutrisi dalam darah untuk kesehatan optimal.</p>`, komposisi: `<p>Ekstrak Stichopus variegatus 250mg.<p>, <p>Ekstrak Channa striata 200mg.</p>`, penyajian: `<p>Dewasa 3 kali sehari 1 kapsul. Ikuti petunjuk pada kemasan.</p>` } },
